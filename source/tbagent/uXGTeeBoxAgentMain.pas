...
begin
  ...
  try
    ...
    try
      ...
      CF.edtClosingAppName.Text := ClosingApp;
      ...
      begin
        ...
        ClosingApp := CF.edtClosingAppName.Text;
        if (not ClosingApp.IsEmpty) and
           (not FileExists(Global.HomeDir + ClosingApp)) then
          ClosingApp := '';
    ...
    case FTeeBoxPlayMode of
      ...
      TBS_TEEBOX_STOP:
        begin
          ...
          ExtendScreen := False;
          if not Global.ClosingApp.IsEmpty then
            ShellExecute(0, 'open', PChar(Global.HomeDir + Global.ClosingApp), nil, nil, SW_HIDE);
        end
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      WriteString( INI_SECTION_CONFIG, 'ClosingApp', '');
...
begin
  ...
  begin
    ...
    ClosingApp                := ReadString( INI_SECTION_CONFIG, 'ClosingApp', '');
...
begin
  ...
  begin
    ...
    WriteString( INI_SECTION_CONFIG, 'ClosingApp', ClosingApp);
