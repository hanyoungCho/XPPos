...
function Color2HTML(Color: TColor; DefaultValue: string='#000000'): string; safecall;

// function to turn an HTML Color (Hex or Name) to a Delphi TColor
function HTML2Color(const HTML: string; DefaultColor: TColor=$00000000): Integer; safecall;
...
function TranslateColorName(Name: string; DefaultValue: Integer=0): Integer;
var
  I: Integer;
begin
  Result := DefaultValue;
...
function Color2HTML(Color: TColor; DefaultValue: string='#000000'): string;
var
  I: Integer;
...
function HTML2Color(const HTML: string; DefaultColor: TColor=$00000000): Integer;
var
  Offset: Integer;
begin
  try
    ...
    // try for color names
    Result := TranslateColorName(LowerCase(HTML), DefaultColor);
  end;
end;
