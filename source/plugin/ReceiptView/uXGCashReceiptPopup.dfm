object XGCashReceiptPopup: TXGCashReceiptPopup
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'XGCashReceiptPopup'
  ClientHeight = 300
  ClientWidth = 600
  Color = clWhite
  ...
  object panBody: TPanel
    ...
    object Label1: TLabel
      ...
      AutoSize = False
      Caption = #48156#54665' '#45824#49345' '#44552#50529' ('#48320#44221' '#48520#44032')'
      Font.Charset = HANGEUL_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
    ...
    object ckbSelfIssued: TcxCheckBox
      Left = 215
      Top = 57
      AutoSize = False
  ...
  object btmClose: TAdvShapeButton
    Left = 548
    Top = 8
    Width = 44
    Height = 44
