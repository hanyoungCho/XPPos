object XGCardApproveForm: TXGCardApproveForm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ClientHeight = 600
  ...
  object panBody: TPanel
    ...
    object Label4: TLabel
      ...
      Width = 169
      Height = 22
      Caption = #52852#46300#48264#54840' ('#50526' 4'#51088#47532#47564') '#51077#47141
      Font.Charset = HANGEUL_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
      Font.Name = 'Noto Sans CJK KR Regular'
    ...
    object Label5: TLabel
      ...
      Width = 88
      Height = 22
      Caption = #49849#51064#48264#54840' '#51077#47141
      Font.Charset = HANGEUL_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
      Font.Name = 'Noto Sans CJK KR Regular'
    ...
    object edtCardPayAmt: TcxCurrencyEdit
      Left = 256
      Top = 190
      AutoSize = False
      ...
      Properties.OnChange = edtCardPayAmtPropertiesChange
    ...
    object edtCardNo: TcxTextEdit
      ...
      Properties.Nullstring = #52852#46300#48264#54840
      Properties.UseLeftAlignmentOnEditing = False
      ...
      TabOrder = 3
      TextHint = #52852#46300#48264#54840
    ...
    object edtInstMonth: TcxTextEdit
      Left = 274
      Top = 324
      AutoSize = False
      ParentFont = False
      ...
      Properties.UseLeftAlignmentOnEditing = False
      Properties.UseNullString = True
      Properties.OnChange = edtInstMonthPropertiesChange
      Style.BorderStyle = ebsFlat
      Style.Color = clWhite
      Style.Font.Charset = HANGEUL_CHARSET
      Style.Font.Color = 8487297
    ...
    object cbxCardList: TcxLookupComboBox
      Left = 34
      Top = 324
      AutoSize = False
      Enabled = False
      ...
      Properties.ListSource = DSCardList
      Properties.ReadOnly = False
  ...
  object panInput: TPanel
    ...
    ParentBackground = False
    TabOrder = 1
    object btnApprove: TcyAdvSpeedButton
      Tag = 1
      Left = 38
      Top = 394
      Width = 205
    ...
    object ckbUseAppCard: TcxCheckBox
      Left = 59
      Top = 346
    ...
    object ckbImmediateDiscount: TcxCheckBox
      Left = 59
      Top = 311
      ...
      Properties.ImmediatePost = True
      Properties.NullStyle = nssUnchecked
      Properties.OnChange = ckbImmeDiateDCPropertiesChange
      Style.BorderColor = clWindowFrame
      Style.BorderStyle = ebsSingle
      Style.Font.Charset = HANGEUL_CHARSET
      Style.Font.Color = clBlack
  ...
  object MDCardList: TdxMemData
    Indexes = <>
    SortOptions = []
    Left = 80
    Top = 40
    object MDCardListCode: TStringField
      FieldName = 'Code'
      Size = 4
    end
    object MDCardListIssuer: TStringField
      FieldName = 'Issuer'
      Size = 12
    end
    object MDCardListAcquirer: TStringField
      FieldName = 'Acquirer'
      Size = 12
    end
  end
  object DSCardList: TDataSource
    DataSet = MDCardList
    Left = 81
    Top = 96
  end
