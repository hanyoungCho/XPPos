object XGEmergencyReserveForm: TXGEmergencyReserveForm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'XGEmergencyReserveForm'
  ClientHeight = 500
  ClientWidth = 400
  Color = clWhite
  ...
  object lblFormTitle: TLabel
    ...
    Alignment = taCenter
    AutoSize = False
    Caption = #44596#44553' '#53440#49437' '#50696#50557' '#46321#47197
    Color = 6856462
  ...
  object panBody: TPanel
    ...
    object lblReserveTimeLabel: TcxLabel
      Left = 64
      Top = 125
      AutoSize = False
    ...
    object edtPrepareMin: TcxDBSpinEdit
      Left = 157
      Top = 217
      AutoSize = False
      DataBinding.DataField = 'prepare_min'
      DataBinding.DataSource = ClientDM.DSTeeBoxSelected
      ParentFont = False
      ...
      StyleFocused.TextColor = 2130677
      TabOrder = 0
      Height = 40
      Width = 105
    end
    object edtAssignMin: TcxDBSpinEdit
      Left = 157
      Top = 263
      AutoSize = False
      DataBinding.DataField = 'assign_min'
      DataBinding.DataSource = ClientDM.DSTeeBoxSelected
      ParentFont = False
      ParentShowHint = False
      Properties.Alignment.Horz = taCenter
      ...
      StyleFocused.LookAndFeel.Kind = lfOffice11
      StyleFocused.LookAndFeel.NativeStyle = True
      StyleFocused.TextColor = 16744448
      StyleHot.LookAndFeel.Kind = lfOffice11
      StyleHot.LookAndFeel.NativeStyle = True
      TabOrder = 1
      Height = 40
